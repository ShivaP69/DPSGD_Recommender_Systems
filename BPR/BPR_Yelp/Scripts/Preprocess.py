...
def preprocess(data,thereshold=3, filter_user=5,filter_item=5 ):
    ...
    data = data[data[item_col].isin(item_supports[item_supports > filter_item].index)]   # it is woth to mention that after this step beacuse of the next lines, it is possible to have less than 5 item_col

...
def compute_kl_divergence(interacted_distr, reco_distr,flag=0, alpha=0.01):
    """
    ...
    for genre, score in interacted_distr.items():
        ...
        if score>0 and reco_score>0: # because KLD is valid if Q(i) > 0 for any i such that P(i) > 0.

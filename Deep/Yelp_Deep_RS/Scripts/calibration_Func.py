...
def compute_kl_divergence(interacted_distr, reco_distr,flag=1, alpha=0.02):
    """
...
# an important point : KLD does not consider a case that we have new genres in recommended list > because it is not relevant to KLD
